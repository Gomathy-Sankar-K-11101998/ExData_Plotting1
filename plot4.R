...
legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, y.intersp = 0.2, text.font = 1, cex = 0.4, fill = "transparent", border = "white")

with(house_power_consume, plot(Time, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power", lty = par(0.5)))
